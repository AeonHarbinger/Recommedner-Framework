...
{ 
    ...
    public class RecommendationList
    {
        ...
        /// <summary>
        /// Creates new instance of recommendation list with given properties.
        /// </summary>
        /// <param name="userId">Identification of user.</param>
        ...
        public RecommendationList(int userId, List<RecommendedItem> items, DateTime atTime, int responseTime)
        {
            UserId = userId;
            Items = items;
            AtTime = atTime;
